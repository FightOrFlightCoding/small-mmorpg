# Current item-system conflicts (ITEM-03)

ITEM-03 closed the shared capacity planner, `expectedRevision`, typed locks, journal/intents/audit, and persist reasons. Remaining rows stay OPEN until a later numbered ITEM phase names them.
