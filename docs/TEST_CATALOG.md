...
| `inventory_service_test.gd` / `equipment_service_test.gd` / `wallet_service_test.gd` / `progression_service_test.gd` | mirrors; overflow recover opcode; Inventory Recovery panel; unlock buttons survive HUD refresh | VS-T5, T8 |
