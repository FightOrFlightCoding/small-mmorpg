...
| Opcode | Name | Body |
| --- | --- | --- |
| 101 | `FULL_STATE` | `{ protocolVersion, contentHash, tick, zoneId, selfId, players, npcs, enemies, loot, corpses, quests, npcQuestMarkers, inventory, equipment, derived, wallet, progression, abilities, party?, instance? }` |
| 102 | `SNAPSHOT` | `{ protocolVersion, contentHash, tick, zoneId, players, enemies, loot, corpses }` |
