...
| `ability.ts` | S | Ability use, casts, cooldowns, Foundation unlock, hotbar | match casts/cooldowns; progression unlocks/hotbar | none | effects, combat_pipeline, stats, canonical_talents.ts | serialize via progression | USE_ABILITY / CANCEL_CAST / ASSIGN_HOTBAR / UNLOCK_ABILITY | no |
