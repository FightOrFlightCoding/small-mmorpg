...
| `VendorService` | C | MerchantWindow; buy/sell intents | Last approved vendor NPC, session, selected stock/instance | none | `NetworkService` | no | VENDOR_BUY / VENDOR_SELL | no prices |
