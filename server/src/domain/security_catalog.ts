...
export const SECURITY_CONTROLS: SecurityControl[] = [
  ...
  row("production_unlock_any", "progression", "UNLOCK_ABILITY on a production class", "Production classes reject UNLOCK_ABILITY; ownership is derived", "allocate 8/10 ticks", MATCH, "requestId", "unsupported_class", ["progression_hotbar_ceiling.test.ts"]),
