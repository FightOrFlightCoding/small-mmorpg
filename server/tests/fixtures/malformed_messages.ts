...
export const MALFORMED_MESSAGE_FIXTURES: MalformedFixture[] = [
  ...
  },
  {
    ...
    raw: envelope({
      ...
      requestId: "req-heal-spoof",
      heal: 999,
    }),
    codePrefix: "stat_injection:heal",
  },
  {
    name: "xp injection",
    ...
    raw: envelope({
      ...
      amount: 1,
      requestId: "req-xp-inject",
      xp: 9999,
    }),
    codePrefix: "stat_injection:xp",
  },
  {
    ...
    raw: envelope({
      ...
      attributeId: "attr.strength",
      amount: 1,
      requestId: "req-level-inject",
      level: 99,
    }),
    codePrefix: "stat_injection:level",
  },
  {
    name: "gold injection",
    ...
    codePrefix: "stat_injection:gold",
  },
  {
    name: "negative gold",
    ...
    raw: envelope({
      ...
      tradeId: "trade-1",
      amount: 1,
      requestId: "req-neg-gold",
      gold: -5,
    }),
    codePrefix: "stat_injection:gold",
  },
  {
    name: "NaN trade amount",
    opcode: ClientOpcode.TRADE_SET_GOLD,
    raw: '{"protocolVersion":1,"tradeId":"trade-1","amount":null,"requestId":"req-nan-gold"}',
    codePrefix: "invalid_amount",
  },
  {
    name: "Infinity allocate amount",
    opcode: ClientOpcode.ALLOCATE_ATTRIBUTES,
    raw: '{"protocolVersion":1,"attributeId":"attr.strength","amount":1e999,"requestId":"req-inf-alloc"}',
    codePrefix: "invalid_amount",
  },
  {
    name: "nested object on resync",
    opcode: ClientOpcode.RESYNC_REQUEST,
    raw: envelope({ protocolVersion: PROTOCOL_VERSION, nested: { x: 1 } }),
    codePrefix: "unknown_field:nested",
  },
  {
    name: "credit recipient spoof",
    opcode: ClientOpcode.ATTACK,
    raw: envelope({
      protocolVersion: PROTOCOL_VERSION,
      targetId: "enemy.green_slime:0",
      requestId: "req-credit-spoof",
      creditUserIds: ["user-alice"],
    }),
    codePrefix: "stat_injection:creditUserIds",
  },
  {
    name: "forged party members",
    opcode: ClientOpcode.TRADE_INVITE,
    raw: envelope({
      protocolVersion: PROTOCOL_VERSION,
      targetId: "user-bob",
      requestId: "req-members-spoof",
      members: ["user-alice"],
    }),
    codePrefix: "stat_injection:members",
  },
];
