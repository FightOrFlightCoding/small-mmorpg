...
func sync_windows() -> void:
	...
	if _hud.has_method("set_panel_visible"):
		...
		_hud.set_panel_visible(WindowManager.ATTRIBUTES, WindowManager.is_open(WindowManager.ATTRIBUTES))
		_hud.set_panel_visible(WindowManager.SKILLS, WindowManager.is_open(WindowManager.SKILLS))
