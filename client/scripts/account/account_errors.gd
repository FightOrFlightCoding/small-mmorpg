...
const ALIASES := {
	...
	"CHARACTER_NAME_HELD_DELETED": "CHARACTER_NAME_HELD_DELETED",
	"name_held_deleted": "CHARACTER_NAME_HELD_DELETED",
...
const MESSAGES := {
	...
	"CHARACTER_NAME_HELD_DELETED": "That name still belongs to a recently deleted character on this account. Open Recently Deleted and restore it, or wait seven days for the name to be released.",
