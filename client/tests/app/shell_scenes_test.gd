...
func test_all_shell_scenes_instantiate() -> void:
	var paths: PackedStringArray = PackedStringArray([
		...
		"res://scenes/login/forgot_password.tscn",
		"res://scenes/login/password_reset_code.tscn",
		"res://scenes/login/password_reset_new.tscn",
		"res://scenes/login/password_changed.tscn",
		"res://scenes/login/change_password.tscn",
