...
func test_scene_paths_resolve() -> void:
	...
	assert_str(SceneRouter.scene_path(SceneRouter.SCENE_ACCOUNT_DELETE)).is_equal("res://scenes/login/account_delete.tscn")
	assert_str(SceneRouter.scene_path(SceneRouter.SCENE_ACCOUNT_DELETED)).is_equal("res://scenes/login/account_deleted.tscn")
...
func test_change_password_and_email_require_auth() -> void:
	...
	assert_bool(SceneRouter.transition_to(SceneRouter.SCENE_ACCOUNT_DELETE)).is_false()
	AppState.notify_authenticated("user-alice", "alice")
	...
	assert_bool(SceneRouter.transition_to(SceneRouter.SCENE_ACCOUNT_DELETE)).is_true()
	assert_bool(SceneRouter.transition_to(SceneRouter.SCENE_ACCOUNT_DELETED)).is_true()
