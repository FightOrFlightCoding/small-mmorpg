...
Canonical git line is **`origin/main`**. Last accepted phase is **ITEM-01** ([docs/PROGRESS.md](docs/PROGRESS.md)). Playable gameplay remains the NPC-07 / PROG-15 Foundation line. ITEM-01 is documentation only. Continue new work on **`origin/main`**. Do not treat stacked `cursor/*` branches as the playable line.
