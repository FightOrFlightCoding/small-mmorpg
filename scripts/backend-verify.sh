...
if (!rpcs.includes("character_bootstrap") || !rpcs.includes("find_or_create_starter_zone") || !rpcs.includes("character_list") || !rpcs.includes("session_handshake")) process.exit(3);
' "$health"
